...
export default function AgentSetup() {
  ...
  function makeReusableInput(step: SetupStep): void {
    ...
    updateStep(step.id, { inputName, value: undefined });
  }
    ...
    <main className="agent-setup">
      ...
      <div className="setup-shell">
        ...
        <section className="setup-content" aria-busy={busy}>
          ...
          {screen === "review" && <Review steps={steps} inputs={inputs} busy={busy} onUpdateStep={updateStep} onRemoveStep={removeStep} onMakeReusable={makeReusableInput} onUpdateInput={updateInput} onBack={() => setScreen("demonstrate")} onContinue={continueToTest} />}
